...
export default function ReposScoredBadge({ label, className = '' }: ReposScoredBadgeProps) {
  ...
  return (
    <span
      className={`inline-flex items-center gap-2 rounded-full border border-[#303A55] bg-[#202941] px-3 py-1.5 text-[11px] font-medium tabular-nums text-[#A7B0C3] sm:text-xs ${className}`}
    >
